package zs.xmx.lib_utils.keyboard;
...
import zs.xmx.utils.GlobalUtils;
...
public class KeyboardToggleUtils {
    ...
    public static void showSoftInput(View view) {
        ...
        view.requestFocus();
        InputMethodManager imm = (InputMethodManager) GlobalUtils.getApp().getSystemService(Context.INPUT_METHOD_SERVICE);
        if (imm == null) return;
        imm.showSoftInput(view, InputMethodManager.SHOW_FORCED);
    }
