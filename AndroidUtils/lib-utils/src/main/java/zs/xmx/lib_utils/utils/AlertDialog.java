 ...
 * @创建时间   2018/7/3 22:28
 * @本类描述	  单例实现的自定Dialog
 * @内容说明   todo 后面直接写一个DialogFragment
 *            todo 稍微改一下,做成自定义Layout
 *
 * 使用方式:
 *      AlertDialog alertDialog = AlertDialog.getInstance(MainActivity.this);
...
public class AlertDialog {
    ...
    public AlertDialog builder() {
        ...
        View view = View.inflate(context, R.layout.dialog_single, null);
        // 获取自定义Dialog布局中的控件
