package zs.xmx.lib_utils.LoctionUtilsDemo;
...
public class LocationService extends Service {
    ...
    private LocationUtils.OnLocationChangeListener mOnLocationChangeListener = new LocationUtils
        ...
        public void getLastKnownLocation(Location location) {
            ...
            if (mOnGetLocationListener != null) {
                mOnGetLocationListener.getLocation(lastLatitude, lastLongitude, latitude, longitude, country,
                        locality, street);
            }
        }
        ...
        public void onLocationChanged(final Location location) {
            ...
            country = LocationUtils.getCountryName(App.getInstance(), Double.parseDouble(latitude), Double
                    .parseDouble(longitude));
            locality = LocationUtils.getLocality(App.getInstance(), Double.parseDouble(latitude), Double.parseDouble
                    (longitude));
            street = LocationUtils.getStreet(App.getInstance(), Double.parseDouble(latitude), Double.parseDouble
                    (longitude));
            if (mOnGetLocationListener != null) {
                mOnGetLocationListener.getLocation(lastLatitude, lastLongitude, latitude, longitude, country,
                        locality, street);
    ...
    public void onCreate() {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (isSuccess)
                    Toast.makeText(App.getInstance(), "init success", Toast.LENGTH_SHORT);
                Looper.loop();
            }
        }).start();
    }
